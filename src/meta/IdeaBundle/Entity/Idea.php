 ...
 *
 * @ORM\Table(name="Idea")
 * @ORM\Entity(repositoryClass="meta\IdeaBundle\Entity\IdeaRepository")
...
class Idea extends Taggable
{
     ...
     * @ORM\OneToMany(targetEntity="meta\IdeaBundle\Entity\Comment\IdeaComment", mappedBy="idea", cascade="remove")
     ...
     * @param \meta\ProjectBundle\Entity\StandardProject $resultingProject
     * @return Idea
     */
    public function setResultingProject(\meta\ProjectBundle\Entity\StandardProject $resultingProject = null)
    {
     ...
     * Add comments
     *
     * @param \meta\IdeaBundle\Entity\Comment\IdeaComment $comment
     * @return Idea
     */
    public function addComment(\meta\IdeaBundle\Entity\Comment\IdeaComment $comment)
    {
        if (!is_null($comment)){
     ...
     * @param \meta\IdeaBundle\Entity\Comment\IdeaComment $comment
     */
    public function removeComment(\meta\IdeaBundle\Entity\Comment\IdeaComment $comment)
    {
        if (!is_null($comment)){
     ...
     * @return Idea
     */
    public function addResultingProject(\meta\ProjectBundle\Entity\StandardProject $resultingProject)
    {
     ...
     * @param \meta\ProjectBundle\Entity\StandardProject $resultingProject
     */
    public function removeResultingProject(\meta\ProjectBundle\Entity\StandardProject $resultingProject)
    {
