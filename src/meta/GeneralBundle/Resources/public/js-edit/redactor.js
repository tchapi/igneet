/*
  ...
  Updated: January 17, 2014
    Contributors :
      ...
      joashxu (https://github.com/joashxu)
...
(function($){
  ...
  Redactor.prototype = {
    ...
    buildColorPicker: function(dropdown, key)
    {
      ...
      var noneColor = $('<a rel="none" href="javascript:void(null);" class="redactor_color_none"></a>').html(RLANG.none);
      $(dropdown).append(noneColor);

      var _self = this;
      $(noneColor).click(function()
      {
        _self.execCommand(mode, 'none');
      });
 ...
 * $('#textdiv').selectText();
 */
(function(e){e.fn.selectText=function(){var t=this[0];if(e.browser.msie){var n=t.offsetParent.createTextRange();n.moveToElementText(t);n.select()}else if(e.browser.mozilla||e.browser.opera){var r=t.ownerDocument.defaultView.getSelection();var n=t.ownerDocument.createRange();n.selectNodeContents(t);r.removeAllRanges();r.addRange(n)}else if(e.browser.safari){var r=t.ownerDocument.defaultView.getSelection();r.setBaseAndExtent(t,0,t,1)}return this};e.event.special.textselect={setup:function(t,n){e(this).data("textselected",false);e(this).bind("mouseup",e.event.special.textselect.handler)},teardown:function(t){e(this).unbind("mouseup",e.event.special.textselect.handler)},handler:function(t){var n=e.event.special.textselect.getSelectedText().toString();if(n!=""){e(this).data("textselected",true);t.type="textselect";t.text=n;e.event.dispatch.call(this,t)}},getSelectedText:function(){var e="";if(window.getSelection){e=window.getSelection()}else if(document.getSelection){e=document.getSelection()}else if(document.selection){e=document.selection.createRange().text}return e}};e.event.special.textunselect={setup:function(t,n){e(this).data("textselected",false);e(this).bind("mouseup",e.event.special.textunselect.handler);e(this).bind("keyup",e.event.special.textunselect.handlerKey)},teardown:function(t){e(this).unbind("mouseup",e.event.special.textunselect.handler)},handler:function(t){if(e(this).data("textselected")){var n=e.event.special.textselect.getSelectedText().toString();if(n==""){e(this).data("textselected",false);t.type="textunselect";e.event.dispatch.call(this,t)}}},handlerKey:function(t){if(e(this).data("textselected")){var n=e.event.special.textselect.getSelectedText().toString();if(t.keyCode==27&&n==""){e(this).data("textselected",false);t.type="textunselect";e.event.dispatch.call(this,t)}}}}})(jQuery)